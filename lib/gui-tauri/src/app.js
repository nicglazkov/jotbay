...
function render() {
  ...
  if (s.update_available) {
    ...
    const managed = state.about && state.about.upgrade_in_place === false;
    $("update-how").textContent =
      managed && state.about.upgrade_instructions ? state.about.upgrade_instructions : "";
    $("btn-upgrade").hidden = !!managed;
  }
